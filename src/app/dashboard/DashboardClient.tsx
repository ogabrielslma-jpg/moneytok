        ...
        <main className="flex-1 max-w-2xl mx-auto pb-24 lg:pb-12">
          ...
          {tab === "feed" && (
            <div className="px-0 lg:px-6 lg:pt-6">
              ...
              {/* === MoneyTok: ProfileHero - espelho do perfil TikTok === */}
              {(() => {
                const tk = profile?.tiktok_profile;
                if (!tk) return null;
                ...
                return (
                  <div className="bg-white border-b lg:border lg:rounded-2xl border-gray-200 px-6 py-8 mb-4 lg:mb-6">
                    <div className="flex flex-col items-center text-center">
                      {/* Avatar */}
                      {tk.avatar_url ? (
                        <img
                          src={tk.avatar_url}
                          alt={tk.display_name || tk.username}
                          className="w-24 h-24 rounded-full object-cover ring-4 ring-white shadow-lg mb-4"
                          referrerPolicy="no-referrer"
                        />
                      ) : (
                        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 flex items-center justify-center text-white text-3xl font-bold mb-4">
                          {(tk.display_name || tk.username || "?")[0].toUpperCase()}
                        </div>
                      )}
                      ...
                      {/* Bio */}
                      {tk.bio && (
                        <p className="text-sm text-gray-600 italic max-w-md leading-relaxed">
                          {tk.bio}
                        </p>
                      )}
                    </div>
